...
// CP_PolygonPlatformDoc.cpp: CCPPolygonPlatformDoc 类的实现
//
...
// CCPPolygonPlatformDoc

IMPLEMENT_DYNCREATE(CCPPolygonPlatformDoc, CDocument)

BEGIN_MESSAGE_MAP(CCPPolygonPlatformDoc, CDocument)
END_MESSAGE_MAP()


// CCPPolygonPlatformDoc 构造/析构
...
BOOL CCPPolygonPlatformDoc::OnNewDocument()
{
...
// 缩略图的支持
void CCPPolygonPlatformDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CCPPolygonPlatformDoc::InitializeSearchContent()
{
...
void CCPPolygonPlatformDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CCPPolygonPlatformDoc 诊断

#ifdef _DEBUG
void CCPPolygonPlatformDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CCPPolygonPlatformDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
