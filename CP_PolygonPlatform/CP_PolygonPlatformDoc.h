...
// CP_PolygonPlatformDoc.h: CCPPolygonPlatformDoc 类的接口
//
...
class CCPPolygonPlatformDoc : public CDocument
{
protected: // 仅从序列化创建
	CCPPolygonPlatformDoc() noexcept;
	DECLARE_DYNCREATE(CCPPolygonPlatformDoc)
