...
BEGIN_MESSAGE_MAP(CCPPolygonPlatformView, CView)
	...
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
	ON_COMMAND(ID_COMBO_AorB, &CCPPolygonPlatformView::OnComboAorb)
	ON_UPDATE_COMMAND_UI(ID_COMBO_AorB, &CCPPolygonPlatformView::OnUpdateComboAorb)
	ON_COMMAND(ID_EDGE_NUMBER, &CCPPolygonPlatformView::OnEdgeNumber)
	ON_COMMAND(ID_TOLERANCE, &CCPPolygonPlatformView::OnTolerance)
	ON_COMMAND(ID_NEW_RIGHT_OUTLOOP, &CCPPolygonPlatformView::OnNewRightOutloop)
	ON_COMMAND(ID_VIEW_STANDARD, &CCPPolygonPlatformView::OnViewStandard)
	ON_COMMAND(ID_VIEW_FIT, &CCPPolygonPlatformView::OnViewFit)
	ON_UPDATE_COMMAND_UI(ID_SELECT_POINT, &CCPPolygonPlatformView::OnUpdateSelectPoint)
	ON_COMMAND(ID_SELECT_POINT, &CCPPolygonPlatformView::OnSelectPoint)
	ON_UPDATE_COMMAND_UI(ID_SELECT_LOOP, &CCPPolygonPlatformView::OnUpdateSelectLoop)
	ON_COMMAND(ID_SELECT_LOOP, &CCPPolygonPlatformView::OnSelectLoop)
	ON_UPDATE_COMMAND_UI(ID_SELECT_REGION, &CCPPolygonPlatformView::OnUpdateSelectRegion)
	ON_COMMAND(ID_SELECT_REGION, &CCPPolygonPlatformView::OnSelectRegion)
	ON_UPDATE_COMMAND_UI(ID_SELECT_POLYGON, &CCPPolygonPlatformView::OnUpdateSelectPolygon)
	ON_COMMAND(ID_SELECT_POLYGON, &CCPPolygonPlatformView::OnSelectPolygon)
	ON_UPDATE_COMMAND_UI(ID_SELECT_TRIANGLE, &CCPPolygonPlatformView::OnUpdateSelectTriangle)
	ON_COMMAND(ID_SELECT_TRIANGLE, &CCPPolygonPlatformView::OnSelectTriangle)
	ON_UPDATE_COMMAND_UI(ID_SELECT_ONLY, &CCPPolygonPlatformView::OnUpdateSelectOnly)
	ON_COMMAND(ID_SELECT_ONLY, &CCPPolygonPlatformView::OnSelectOnly)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEHOVER()
	ON_COMMAND(ID_NEW_RIGHT_INLOOP, &CCPPolygonPlatformView::OnNewRightInloop)
	ON_COMMAND(ID_ADD_OUTLOOP, &CCPPolygonPlatformView::OnAddOutloop)
	ON_COMMAND(ID_ADD_INLOOP, &CCPPolygonPlatformView::OnAddInloop)
	ON_COMMAND(ID_ADD_POINT, &CCPPolygonPlatformView::OnAddPoint)
	ON_COMMAND(ID_DELETE, &CCPPolygonPlatformView::OnDelete)
	ON_UPDATE_COMMAND_UI(ID_MOVE_SAME, &CCPPolygonPlatformView::OnUpdateMoveSame)
	ON_COMMAND(ID_MOVE_SAME, &CCPPolygonPlatformView::OnMoveSame)
	ON_UPDATE_COMMAND_UI(ID_VIEW_A, &CCPPolygonPlatformView::OnUpdateViewA)
	ON_COMMAND(ID_VIEW_A, &CCPPolygonPlatformView::OnViewA)
	ON_UPDATE_COMMAND_UI(ID_VIEW_B, &CCPPolygonPlatformView::OnUpdateViewB)
	ON_COMMAND(ID_VIEW_B, &CCPPolygonPlatformView::OnViewB)
	ON_UPDATE_COMMAND_UI(ID_VIEW_POINT_ID, &CCPPolygonPlatformView::OnUpdateViewPointId)
	ON_COMMAND(ID_VIEW_POINT_ID, &CCPPolygonPlatformView::OnViewPointId)
	ON_COMMAND(ID_VIEW_T_FACE, &CCPPolygonPlatformView::OnViewTFace)
	ON_UPDATE_COMMAND_UI(ID_VIEW_T_FACE, &CCPPolygonPlatformView::OnUpdateViewTFace)
END_MESSAGE_MAP()

// CCPPolygonPlatformView 构造/析构

CCPPolygonPlatformView::CCPPolygonPlatformView() noexcept
{
	// TODO: 在此处添加构造代码
...
void  CCPPolygonPlatformView::mb_statusSetText(char* s1, char* s2)
{
	CRect r;
	// View中获取MainFrame指针
...
void CCPPolygonPlatformView::OnUpdateComboAorb(CCmdUI* pCmdUI)
{
...
void CCPPolygonPlatformView::OnComboAorb()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnEdgeNumber()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnTolerance()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnNewRightOutloop()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewStandard()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewFit()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectPoint(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectPoint()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectLoop(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectLoop()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectRegion(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectRegion()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectPolygon(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectPolygon()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectTriangle(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectTriangle()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateSelectOnly(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnSelectOnly()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/*这一部分需要从类视图中，添加消息机制*/
void CCPPolygonPlatformView::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CCPPolygonPlatformView::OnLButtonUp(UINT nFlags, CPoint point)
{
...
void CCPPolygonPlatformView::OnMouseHover(UINT nFlags, CPoint point)
{
...
void CCPPolygonPlatformView::OnNewRightInloop()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnAddOutloop()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnAddInloop()
{
		// TODO: 在此添加命令处理程序代码
		CCPPolygonPlatformDoc* pDoc = GetDocument();
		ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnAddPoint()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnDelete()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateMoveSame(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnMoveSame()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateViewA(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewA()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateViewB(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewB()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateViewPointId(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewPointId()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnViewTFace()
{
	// TODO: 在此添加命令处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCPPolygonPlatformView::OnUpdateViewTFace(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCPPolygonPlatformDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
